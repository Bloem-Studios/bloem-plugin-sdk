...
const file_silo_plugin_v1_scan_source_proto_rawDesc = "" +
	...
	"\n" +
	"ScanSource\x12V\n" +
	"\vPollChanges\x12\".silo.plugin.v1.PollChangesRequest\x1a#.silo.plugin.v1.PollChangesResponseBSZQgithub.com/Bloem-Studios/bloem-plugin-sdk/pkg/pluginproto/silo/plugin/v1;pluginv1b\x06proto3"
