...
const file_silo_plugin_v1_metadata_provider_proto_rawDesc = "" +
	...
	"\rImageResolver\x12b\n" +
	"\x0fResolveImageURL\x12&.silo.plugin.v1.ResolveImageURLRequest\x1a'.silo.plugin.v1.ResolveImageURLResponse\x12e\n" +
	"\x10ResolveImageURLs\x12'.silo.plugin.v1.ResolveImageURLsRequest\x1a(.silo.plugin.v1.ResolveImageURLsResponseBSZQgithub.com/Bloem-Studios/bloem-plugin-sdk/pkg/pluginproto/silo/plugin/v1;pluginv1b\x06proto3"
